...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _props2 = this.props,
        ...
        props = (0, _objectWithoutProperties2.default)(_props2, ["active", "disabled", "divider", "header", "onClick", "className"]);
    ...
    if (divider) {
      ...
      return _react.default.createElement("div", (0, _extends2.default)({}, elementProps, {
        role: "separator",
        className: (0, _classnames.default)(className, (0, _bootstrapUtils.prefix)(bsProps, 'divider'))
      }));
    }
    ...
    return _react.default.createElement(_SafeAnchor.default, (0, _extends2.default)({}, elementProps, {
      role: "menuitem",
      tabIndex: "-1",
