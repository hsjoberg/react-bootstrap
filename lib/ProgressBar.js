...
function (_React$Component) {
  ...
  _proto.renderProgressBar = function renderProgressBar(_ref) {
    ...
    var min = _ref.min,
        ...
        props = (0, _objectWithoutProperties2.default)(_ref, ["min", "now", "max", "label", "srOnly", "striped", "animated", "className", "style", "variant", "bsPrefix"]);
  ...
  _proto.render = function render() {
    ...
    var min = props.min,
        ...
        wrapperProps = (0, _objectWithoutProperties2.default)(props, ["min", "now", "max", "label", "srOnly", "striped", "animated", "bsPrefix", "variant", "className", "children"]);
...
var DecoratedProgressBar = (0, _ThemeProvider.createBootstrapComponent)(ProgressBar, 'progress-bar');
