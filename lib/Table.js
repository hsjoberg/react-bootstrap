...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _props = this.props,
        ...
        props = (0, _objectWithoutProperties2.default)(_props, ["bsPrefix", "striped", "bordered", "hover", "size", "variant", "responsive"]);
    var classes = (0, _classnames.default)(bsPrefix, variant && bsPrefix + "-" + variant, size && bsPrefix + "-" + size, striped && bsPrefix + "-striped", bordered && bsPrefix + "-bordered", hover && bsPrefix + "-hover");
